            ...
            //creation du portefeuille de l'utilisateur
                   ...
                   if ($request->role === 'passager') {
                    ...
                    if ($request->role === 'chauffeur') {
                        ...
                        Chauffeur::create([
                            'id_user' => $user->id,
                            'numero_permis' => $request->numero_permis?? "00000",
                            'photo_piece_identite' => $request->photo_piece_identite ?? "photo", // On enregistre le chemin relatif
                        ]);
